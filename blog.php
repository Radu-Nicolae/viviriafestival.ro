          ...
          <div class="row">
              <div class="col-md-12 page-content position-relative">
                  ...
                  <div class="page_nav bg-white d-inline-block">
                      <span>You are here:</span> <a href="index.html" class="d-inline-block color-black">Home</a> <span class="color-summer-sky"><i class="ti ti-angle-double-right"></i>Blog</span>
                  </div>
              </div>
          </div>
      </div>
         ...
         <div class="col-lg-8 col-md-7">
             <div class="blog-box heading-space">
                 ...
                 <div class="blog-listing-inner news_item">
                     ...
                     <div class="news_desc">
                         <h3 class="text-capitalize font-weight-500"><a href="blog-detail-dark.html" class="color-black">Profolic and Visionary Works!</a></h3>
             ...
             <div class="blog-box heading-space">
                 ...
                 <div class="blog-listing-inner news_item">
                     <div class="image hover-effect">
                         <img src="images/blog4.jpg" alt="blog-img">
                     </div>
                     <div class="news_desc">
                         <h3 class="text-capitalize font-weight-500"><a href="blog-detail-dark.html" class="color-black">Precious Time and Assets!</a></h3>
                         <ul class="meta-tags mt-20px mb-20px">
                         ...
                         <p class="mb-35px color-grey line-height-25px">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                         <a href="blog-detail-dark.html" class="btn-setting btn-hvr-setting-main btn-black">Read More
                             <span class="btn-hvr-setting">
					    	   <span class="btn-hvr-setting-inner">
					    		 <span class="btn-hvr-effect"></span>
                                 <span class="btn-hvr-effect"></span>
             ...
             <div class="blog-box heading-space mb-xs-5">
                 ...
                 <div class="blog-listing-inner news_item">
                     <div class="image hover-effect">
                         <img src="images/blog5.jpg" alt="blog-img">
                     </div>
                     <div class="news_desc">
                         <h3 class="text-capitalize font-weight-500"><a href="blog-detail-dark.html" class="color-black">Outstanding Catalouge</a></h3>
                         <ul class="meta-tags mt-20px mb-20px">
             ...
             <div class="row">
                 <div class="col-sm-12">
                     ...
                     <ul class="pagination justify-content-center mb-xs-5">
                         <li class="page-item"><a class="page-link" href="#"><i class="ti ti-angle-left"></i></a></li>
