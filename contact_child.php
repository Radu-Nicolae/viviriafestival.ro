...
<div class="contact-box-shadow">
    ...
    <div class="contact-info sm-text-center">
        <div class="icon-box">
            ...
            <p class="color-grey"><a href="tel:0725920491" class="color-grey">+(40) 725 92 04 91</a></p>
        </div>
        <div class="icon-box">
            <i class="ti ti-email color-yellow"></i>
            <p><a href="mailto:viviria.festival@gmail.com" class="color-grey">viviria.festival@gmail.com</a></p>
        </div>
        <div class="icon-box">
