        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12 mx-auto wow fadeInRight">
                ...
                <div class="feature-item">
                    <div class="laptop-features-icon">
                        <span class="icon"><i class="ti ti-light-bulb color-yellow"></i></span>
                    </div>
                    <div class="features-content">
                ...
                <div class="feature-item mb-xs-0">
                    <div class="laptop-features-icon">
                        <span class="icon"><i class="ti ti-ink-pen color-green"></i></span>
                    </div>
                    <div class="features-content">
...
<!-- Work Starts -->
<section id="work" class="bg-black2">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
...
<!-- Contact & Map starts -->
<section id="contact" style="background-color: #d0920e !important" class="parallax-setting parallaxie parallax5">
    <div style="background-color: #d0920e !important" class="bg-overlay bg-black2 opacity-9"></div>
    <div class="container">
